...
public class ClientRiskRanking {
    ...
    public static void bubbleSort(Client[] clients) {
        ...
        System.out.println("BubbleSort result: " + Arrays.toString(clients));
    ...
    public static void insertionSort(Client[] clients) {
        ...
        System.out.println("InsertionSort result: " + Arrays.toString(clients));
    }

    // Comparator: riskScore DESC, then accountBalance ASC
    private static int compare(Client c1, Client c2) {
        ...
        return Double.compare(c1.accountBalance, c2.accountBalance); // ascending
    }
    ...
    public static void main(String[] args) {
        ...
        Client[] sortedClients = Arrays.copyOf(clients, clients.length);
        insertionSort(sortedClients);

        // Top 10 risks
        topRisks(sortedClients, 10);
    }
}
